...
RSpec.describe 'DocumentFileUploader' do
  ...
  let(:production_store_dir_path) do
    "uploads/document/document_file/#{document.id}/test_pdf.pdf"
  end
  ...
  context 'in production environment' do
    it 'finds the directory where uploaded files are stored' do
      ...
      expect(document.document_file.current_path).to include(production_store_dir_path)
    end
  end
end
